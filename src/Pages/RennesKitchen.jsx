    ...
    <>
      <div className="renne-kitchen-block">
        ...
        <div className="renne-kitchen-hero">
          <img
            src="https://res.cloudinary.com/dmqhseusw/image/upload/v1759234735/66aef36f0ba075e40df1c11b76ba9183_hbzmvb.jpg"
            className="renne-kitchen-hero-image"
            alt=""
          />
        ...
        <div className="renne-meal-title-box1">
            ...
            <div className="renne-meal-table-box">
              <div className="renne-meal-table-images">
                <img
                  ...
                  alt=""
                  className="renne-meal-table-images-image"
                />
          ...
          <div className="renne-meal-table-cover">
            ...
            <div className="renne-meal-table-box">
              <div className="renne-meal-table-images">
                <img
                  src="https://res.cloudinary.com/dmqhseusw/image/upload/v1759232797/0f2080fc037eed5073c96867d93c869f_1_z7h4if.jpg"
                  alt=""
                  className="renne-meal-table-images-image"
                />
                <div className="renne-meal-table-images-price">
              ...
              <div className="renne-gomeal-table-box">
                <div className="renne-gomeal-table-images">
                  <img
                    ...
                    alt=""
                    className="renne-gomeal-table-images-image"
                  />
                ...
                <div className="renne-gomeal-table-images-text-btn">
                  <button className="renne-gobtn00091">Order Now</button>
                </div>
              </div>
            </div>
          </div>
